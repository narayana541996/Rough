...
def scp_(source_ssh_file, source_username, source_host, target_ssh_file, copy_filepath, target_username, target_host, target_directory_path, recursive, establish_trust = True, source_password = '', target_password = '', target_key_file_on_source = '', create_key_bits = '1024'):
    ...
    def scp_to(scp_client, target_directory_path, recursive, files = filename):
        ...
        try:
            ...
            response = f'\nCannot find the file to be copied, please make sure that the path entered is correct, or if you\'re trying to copy a folder, turn on recursion.'
...
if __name__ == '__main__':
    scp_(source_ssh_file = r'C:/Users/krish/Downloads/inst-trial-3.pem', source_username ='ubuntu', source_host = '15.206.205.93', source_password = '', target_ssh_file = r'C:/Users/krish/Downloads/inst-trial-3.pem', copy_filepath = '/home/ubuntu/upload_test', target_username = 'ubuntu', target_host = '13.126.14.134', target_directory_path = '~/', recursive = True, target_password = '', target_key_file_on_source = '~/.ssh/id_dsa')
