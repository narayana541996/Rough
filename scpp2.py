...
def scp_from_into(source_key_file_path = None, target_key_file_path, source_username, source_ip, source_filepath, file_path, target_username, target_ip, target_directory):#source_ip, target_ip, file_path, ssh_key
    ...
    print(call(r'scp -i {} {} {}@{}:{}'.format(source_key_file_path,target_key_file_path, source_username, source_ip, source_filepath).split(' ')))
    #enter the source server
    print(call(r'ssh -i {} {}@{}'.format(source_key_file, source_username, source_ip)))
    #get target_key_file from the target_key_file_path
    #local_target_key_file = target_key_file
    #set the target_key_file permissions to read and write
    print(call(r'chmod 600 {}'.format(target_key_file)))
    print(call(r'scp -i {} {} {}@{}:{}'.format(target_key_file, file_path, target_username, target_ip, target_directory)))
    print(call(r'rm {}'.format(target_key_file)))
    print(call('exit'))
#.format(ssh_key,file_path, target_ip)
scp_from_into( source_key_file_path = r'C:\Users\krish\Downloads\inst-trial-2.pem', target_key_file_path = r'C:\Users\krish\Downloads\docker.pem', source_username = 'ubuntu', source_ip = '13.235.91.254', source_filepath = 'home/ubuntu/', file_path = 'home/ubuntu/laborum/laborum.py', target_username = 'root', target_ip = '134.209.148.94', target_directory = 'root/')
